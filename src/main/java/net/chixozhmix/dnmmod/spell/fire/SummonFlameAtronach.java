...
public class SummonFlameAtronach extends AbstractSpell {
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        for(int i = 0; i < spellLevel; ++i) {
            FlameAtronachEntity undead = new FlameAtronachEntity(level, entity, true);
            ...
            undead.addEffect(new MobEffectInstance(ModEffects.SUMMON_FLAME_ATRONACH.get(), summonTime, 0, false, false, false));
        ...
        if (entity.hasEffect((MobEffect)ModEffects.SUMMON_FLAME_ATRONACH.get())) {
            effectAmplifier += entity.getEffect((MobEffect)ModEffects.SUMMON_FLAME_ATRONACH.get()).getAmplifier() + 1;
        }

        entity.addEffect(new MobEffectInstance((MobEffect)ModEffects.SUMMON_FLAME_ATRONACH.get(), summonTime, effectAmplifier, false, false, true));
