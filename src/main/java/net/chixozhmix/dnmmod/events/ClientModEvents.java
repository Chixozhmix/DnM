...
import net.chixozhmix.dnmmod.entity.evil.defiled_wizard.DefiledWizardRenderer;
import net.chixozhmix.dnmmod.entity.evil.evil_flame_atronach.EvilFlameAtronachRenderer;
import net.chixozhmix.dnmmod.entity.evil.evil_storm_atronach.EvilStormAtronachRenderer;
import net.chixozhmix.dnmmod.entity.summons.flame_atronach.FlameAtronachrenderer;
import net.chixozhmix.dnmmod.entity.evil.ghost.GhostRenderer;
import net.chixozhmix.dnmmod.entity.evil.goblin_shaman.GoblinShamanRenderer;
import net.chixozhmix.dnmmod.entity.evil.goblin_warior.GoblinWariorRenderer;
import net.chixozhmix.dnmmod.entity.evil.greemon.GreemonRenderer;
import net.chixozhmix.dnmmod.entity.bosses.green_hag.GreenHagRenderer;
import net.chixozhmix.dnmmod.entity.evil.hidden_tentacle.HiddenTentacleRenderer;
import net.chixozhmix.dnmmod.entity.bosses.leshy.LeshyRenderer;
import net.chixozhmix.dnmmod.entity.bosses.modeus.ModeusRenderer;
import net.chixozhmix.dnmmod.entity.neutral.raven.RavenModel;
import net.chixozhmix.dnmmod.entity.neutral.raven.RavenRenderer;
import net.chixozhmix.dnmmod.entity.evil.reaper.ReaperRenderer;
import net.chixozhmix.dnmmod.entity.evil.small_ice_spider.SmallIceSpiderRenderer;
...
import net.chixozhmix.dnmmod.entity.summons.storm_atronach.StormAtronachRenderer;
import net.chixozhmix.dnmmod.entity.summons.summoned.client.SummonedRavenModel;
import net.chixozhmix.dnmmod.entity.summons.summoned.client.SummonedRavenRenderer;
import net.chixozhmix.dnmmod.entity.summons.summoned.client.SummonedUndeadSpiritRenderer;
import net.chixozhmix.dnmmod.entity.evil.tainted_observer.DarkspawnObserverRenderer;
import net.chixozhmix.dnmmod.items.client.arrows.IceArrowRenderer;
import net.chixozhmix.dnmmod.items.custom.TaintedCompassItem;
...
public class ClientModEvents {
    ...
    public static void onClientSetup(FMLClientSetupEvent event)
    {
        ...
        ItemProperties.register(ModItems.TAINTED_COMPASS.get(), ResourceLocation.withDefaultNamespace("angle"),
                new CompassItemPropertyFunction((pLevel, pStack, pEntity)
                        -> TaintedCompassItem.getTempleLocation(pEntity, pStack.getOrCreateTag())));
        ...
        //Dragons
        EntityRenderers.register(ModEntityType.ABSTRACT_DRAGON.get(), AbstractDragonRenderer::new);
