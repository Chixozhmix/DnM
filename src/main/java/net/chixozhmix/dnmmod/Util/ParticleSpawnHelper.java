...
public class ParticleSpawnHelper {
    ...
    public static void spawnParticlesCelindr(Level level, Entity entity, int particleCount, ParticleOptions particleType, ParticleDirection direction, double radius, double height, double yOffset) {
        if (!level.isClientSide) {
            ...
            for(int i = 0; i < particleCount; ++i) {
                ...
                } else if (direction == ParticleDirection.DOWNWARD) {
                    directionVector = (new Vec3((double)0.0F, (double)-1.0F, (double)0.0F)).normalize();
                } else if (direction == ParticleDirection.INWARD) {
