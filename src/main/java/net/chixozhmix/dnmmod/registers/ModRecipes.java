...
public class ModRecipes {
    ...
    public static final RegistryObject<RecipeSerializer<ScrollTableRecipe>> SCROLL_TABLE_RECIPE =
            SERIALIZERS.register("scroll_table", () -> ScrollTableRecipe.Serializer.INSTANCE);
