package net.chixozhmix.dnmmod.entity.neutral.raven;
...
public class RavenRenderer extends MobRenderer<RavenEntity, RavenModel> {
    ...
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DnMmod.MOD_ID, "raven"), "main");
