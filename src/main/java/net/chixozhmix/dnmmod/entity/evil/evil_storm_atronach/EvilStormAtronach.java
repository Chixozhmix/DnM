...
public class EvilStormAtronach extends AbstractSpellCastingMob implements Enemy, GeoEntity {
    private static final RawAnimation IDLE_ANIM = RawAnimation.begin().thenLoop("idle");
    private static final RawAnimation WALK_ANIM = RawAnimation.begin().thenLoop("walk");

    private final AnimatableInstanceCache cache;

    private final AnimationController<EvilStormAtronach> movementController;
    ...
    public EvilStormAtronach(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);

        this.cache = GeckoLibUtil.createInstanceCache(this);
        this.xpReward = 8;

        this.movementController = new AnimationController<>(this, "movement", this::movementPredicate);
    }
    ...
    private PlayState movementPredicate(AnimationState<EvilStormAtronach> state) {
        if (state.isMoving()) {
