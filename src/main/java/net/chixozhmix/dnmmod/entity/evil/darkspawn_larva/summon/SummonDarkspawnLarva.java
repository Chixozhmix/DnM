package net.chixozhmix.dnmmod.entity.evil.darkspawn_larva.summon;
...
public class SummonDarkspawnLarva extends DarkspawnLarva implements IMagicSummon {
    ...
    public SummonDarkspawnLarva(EntityType<? extends PathfinderMob> pEntityType, Level pLevel) {
    ...
    public SummonDarkspawnLarva(Level level, LivingEntity owner, boolean playRiseAnimation) {
        this(ModEntityType.SUMMON_DARKSPAWN_LARVA.get(), level);
    ...
    private PlayState risePredicate(AnimationState<SummonDarkspawnLarva> state) {
