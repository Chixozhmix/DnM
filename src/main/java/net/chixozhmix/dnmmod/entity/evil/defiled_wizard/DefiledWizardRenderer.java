package net.chixozhmix.dnmmod.entity.evil.defiled_wizard;
...
public class DefiledWizardRenderer extends AbstractSpellCastingMobRenderer {
    private static final ResourceLocation EMISSIVE_TEXTURE =
            new ResourceLocation(DnMmod.MOD_ID, "textures/entity/defiled_wizard/defiled_wizard_glowing.png");

    public DefiledWizardRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DefiledWizardModel());
    }
