...
public class IceDaggerRenderer extends EntityRenderer<IceDagger> {
    ...
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("dnmmod", "ice_dagger_model"), "main");
    ...
    public ResourceLocation getTextureLocation(IceDagger animatable) {
        return new ResourceLocation(DnMmod.MOD_ID, "textures/entity/ice_dagger.png");
    }
