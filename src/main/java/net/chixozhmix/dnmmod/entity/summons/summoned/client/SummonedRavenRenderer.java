...
public class SummonedRavenRenderer extends MobRenderer<SummonedRavenEntity, SummonedRavenModel> {
    public static final ModelLayerLocation MODEL_LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(DnMmod.MOD_ID, "summon_raven"), "main");
    ...
    public ResourceLocation getTextureLocation(SummonedRavenEntity entity) {
        return new ResourceLocation(DnMmod.MOD_ID, "textures/entity/raven.png");
    }
