...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLADE_RUNE.get(), 1)
                ...
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLADESINGER_BOOTS.get(), 1)
                .pattern("   ")
                .pattern("CRC")
                .pattern("C C")
                ...
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLADESINGER_LEGGINGS.get(), 1)
                .pattern("CCC")
                .pattern("CRC")
                .pattern("C C")
                .define('R', ModItems.BLADE_RUNE.get())
                ...
                .unlockedBy("has_blade_rune", has(ModItems.BLADE_RUNE.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLADESINGER_CHESTPLATE.get(), 1)
                .pattern("CRC")
                .pattern("CCC")
                .pattern("CCC")
                .define('R', ModItems.BLADE_RUNE.get())
                ...
                .unlockedBy("has_blade_rune", has(ModItems.BLADE_RUNE.get()))
                .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.BLADESINGER_HELMET.get(), 1)
                .pattern("   ")
                .pattern("CCC")
                .pattern("CRC")
                .define('R', ModItems.BLADE_RUNE.get())
