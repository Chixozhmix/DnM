...
//    public static final RegistryObject<Attribute> BLOOD;
...
//    }
//
//    public static RegistryObject<Attribute> baseRangedAttribute(String id) {
//        return ATTRIBUTES.register(id, () -> (new RangedAttribute("attribute.dnmmod." + id, (double)50.0D, (double)0.0D, (double)10000.0D)).setSyncable(true));
//    }
//
//    @SubscribeEvent
